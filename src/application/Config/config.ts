...
const envs = [
    ...
    'GPT_PDF_PROMPT',
    'GPT_COVER_LETTER_RESUME_PROMPT',
    'GPT_COVER_LETTER_MANUAL_PROMPT',
    'SMTP_HOST',
    'AUTH_EMAIL',
    'AUTH_EMAIL_PASSWORD',
];
...
export default {
    ...
    PROMPTS: {
        MANUAL: process.env.GPT_COVER_LETTER_MANUAL_PROMPT,
        RESUME: process.env.GPT_COVER_LETTER_RESUME_PROMPT,
